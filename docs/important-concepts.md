...
An example of how this works can be found in the script `@./bitwig6/suites/zsaudio/lcxl3-ar/lcxl3-ar.control.js`
...
You can find a working example in the script `@./bitwig6/suites/zsaudio/lcxl3-ar/lcxl3-ar.control.js`.